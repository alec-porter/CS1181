public class Clock {
    ...
    public Clock(int hours, int minutes, String meridian) {
        ...
        // make sure minutes input is between 0 and 60
        if (minutes >= 0 && minutes <= 60 ){
            this.minutes = minutes;
        }
        else{
            this.minutes = 0;  
            // a while loop that forces a correct input is much better than setting to zero because the program is taking an action the user is not aware of and could generate erroneous data
        }
    }

    // add to get the minutes from the class for testing
